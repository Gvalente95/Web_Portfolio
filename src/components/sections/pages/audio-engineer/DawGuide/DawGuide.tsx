    ...
    <div className="page-container">
      <div className="daw-guide-layout">
        ...
        <div className="daw-guide">
          ...
          <p className="daw-guide__body">Select and open a project from your project list.</p>
          {/* SAVING A PROJECT */}
          ...
          <p className="daw-guide__body">
            You'll find the same structure of any standard daw such as Logic Pro X, Pro-tools, Ableton. <br />
